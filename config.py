"""
Configuration for Bale Bot.
Tokens and settings are loaded from environment variables or .env file.
"""
...
class Config:
    ...
    # Telegram -> Bale user mapping: {"telegram_user_id": "bale_user_id"}
    USER_MAPPING: dict = {}

    # File size limit for downloads (50 MB — Telegram bot max)
    # Bale's 20 MB limit is handled by auto-splitting in bot.py
    MAX_FILE_SIZE: int = 50 * 1024 * 1024

    # Downloads directory
    DOWNLOAD_DIR: str = os.getenv("DOWNLOAD_DIR", "/tmp/bale-bot-downloads")
